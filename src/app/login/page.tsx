...
import PeopleIMG from "@/app/assets/people_img.png";

import Image from "next/image";
export default function Login() {
  return (
    <div id="login" style={{ height: "100vh" }} className="flex">
      <div className="flex min-h-full flex-1 flex-col justify-center items-center px-6 py-12 lg:px-8c">
        <Image width={700} height={500} src={PeopleIMG} alt="people-logo" />
      </div>
